    ...
    "offers": [
      {
        ...
        "charges": [
          { "passengerType": "ADT", "chargeType": "FARE", "price": 5.00 },
          { "passengerType": "ADT", "chargeType": "TAX",  "price": 1.00 }
        ],
        "freeAncillaryRefs": [
      ...
      },
      {
        ...
        "charges": [
          { "passengerType": "ADT", "chargeType": "FARE", "price": 7.00 },
      ...
      },
      {
        ...
        "charges": [
          { "passengerType": "ADT", "chargeType": "FARE", "price": 4.00 },
          { "passengerType": "ADT", "chargeType": "TAX",  "price": 0.80 }
        ],
        "freeAncillaryRefs": [
...
|---|---|---|---|---|---|---|
| 0 | JT | `JT\|CGK\|DPS\|2026-07-10\|BASIC` | 0 | 5.00 | 1.00 | 0 (0) |
...
|---|---|---|---|---|---|---|
| 3 | AK | `AK\|CGK\|DPS\|2026-07-10\|BASIC` | 3.00 | 0.50 | 0  | 5, 10, 15 |
...
GA (FBA 20) shown → 25/30/35 kg. (JT/QZ FBA 0 → 5/10/15 kg.) Price = `kg * 0.25` USD (mock rule).
```json
{
  "code": 0,
  "msg": "success",
  "data": {
    "currency": "USD",
    "ancillaryOffers": [
      { "addAncillaryType": "CHECKEDBAGGAGE", "ancillaryKey": "1_0_0$GA200$PA25", "ancillaryCode": 25, "ancillaryPiece": 1, "unitOfMeasurement": "WEIGHT", "desc": "25kg", "oriAirport": "CGK", "destAirport": "DPS", "transferAirport": "", "flightNumber": "GA200", "price": 6.25 },
      { "addAncillaryType": "CHECKEDBAGGAGE", "ancillaryKey": "1_0_0$GA200$PA30", "ancillaryCode": 30, "ancillaryPiece": 1, "unitOfMeasurement": "WEIGHT", "desc": "30kg", "oriAirport": "CGK", "destAirport": "DPS", "transferAirport": "", "flightNumber": "GA200", "price": 7.50 },
      { "addAncillaryType": "CHECKEDBAGGAGE", "ancillaryKey": "1_0_0$GA200$PA35", "ancillaryCode": 35, "ancillaryPiece": 1, "unitOfMeasurement": "WEIGHT", "desc": "35kg", "oriAirport": "CGK", "destAirport": "DPS", "transferAirport": "", "flightNumber": "GA200", "price": 8.75 }
    ]
  }
}
```

**JT/QZ example** (FBA 0 → 5/10/15): `ancillaryKey` `1_0_0$JT100$PA5`, codes 5/10/15, prices 1.25/2.50/3.75.
...
**Success response** — `orderId` is a fresh random 10-digit string; `total` = FARE+TAX+ancillary = 7+2+6.25.
```json
{
  "code": 0,
  "msg": "success",
